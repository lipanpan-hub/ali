...
_See code: [src/commands/img/add.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.9/src/commands/img/add.ts)_
...
_See code: [src/commands/img/del.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.9/src/commands/img/del.ts)_
...
_See code: [src/commands/img/list.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.9/src/commands/img/list.ts)_
