...
_See code: [src/commands/sgp/add.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.5/src/commands/sgp/add.ts)_
...
_See code: [src/commands/sgp/del.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.5/src/commands/sgp/del.ts)_
...
_See code: [src/commands/sgp/list.ts](https://github.com/lipanpan-hub/ali/blob/v0.0.5/src/commands/sgp/list.ts)_
